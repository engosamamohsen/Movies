...
object Constants {
  ...
  const val PROFILE: Int = 19
  const val NOT_MATCH_PASSWORD: Int = 20
  const val UPDATE_PASSWORD: Int = 21
  const val COUNTRIES: Int = 22
  const val EDUCATIONS: Int = 23
  const val SUBJECTS: Int = 24
  const val MY_EXAMS: Int = 25
  const val TEACHER: Int = 26
  const val STUDENT: Int = 27
  const val NEW_GROUP: Int = 27
